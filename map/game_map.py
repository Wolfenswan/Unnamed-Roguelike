    ...
    def place_entities(self, room, entities, max_monsters_per_room, max_items_per_room):
        ...
        for i in range(number_of_monsters):
            ...
            if randint(0, 100) > 0:
                ...
                monster = NPC(x, y, 'o', tcod.desaturated_green, 'Orc',
                ...
                monster = NPC(x, y, 'T', tcod.darker_green, 'Troll', fighter=fighter_component,
                                 ai=ai_component)
                entities.append(monster)
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_chance < 70:
                    item_component = Item(use_function=heal_entity, amount=4)
                    item = Entity(x, y, '!', tcod.violet, 'Healing Potion', render_order=RenderOrder.ITEM,
                                  item=item_component)
                elif item_chance < 80:
                    item_component = Item(use_function=cast_fireball_on, targeting=True, targeting_message=Message(
                    ...
                    item_component = Item(use_function=cast_confuse_on, targeting=True, targeting_message=Message(
                    ...
                    item_component = Item(use_function=cast_lightning_on, damage=20, maximum_range=5)
